...
export type PeriodType = 'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'reboot';
export type AllowEmpty = 'always' | 'never' | 'for-default-value';
export type CronType = 'period' | 'months' | 'month-days' | 'week-days' | 'hours' | 'minutes' | 'seconds';
export type LeadingZeroType = 'month-days' | 'hours' | 'minutes' | 'seconds';
