...
interface Locale {
    ...
    emptySecondsForMinutePeriod?: string;
    yearOption?: string;
    monthOption?: string;
    weekOption?: string;
    dayOption?: string;
    ...
    prefixSecondsForMinutePeriod?: string;
    suffixMinutesForHourPeriod?: string;
    suffixSecondsForMinutePeriod?: string;
...
type PeriodType = 'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'reboot';
type AllowEmpty = 'always' | 'never' | 'for-default-value';
type CronType = 'period' | 'months' | 'month-days' | 'week-days' | 'hours' | 'minutes' | 'seconds';
type LeadingZeroType = 'month-days' | 'hours' | 'minutes' | 'seconds';
...
interface SecondsProps extends FieldProps {
    leadingZero: LeadingZero;
    clockFormat?: ClockFormat;
}
